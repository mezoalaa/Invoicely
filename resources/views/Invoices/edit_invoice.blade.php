                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    ...
                                    <option value="5">5%</option>  <!-- Corrected value -->
                                    <option value="10">10%</option> <!-- Corrected value -->
                                </select>
                            </div>
...
@section('js')
    ...
    <script>
   function myFunction() {
        // Retrieve values and parse them as floats
        var Amount_collection = parseFloat(document.getElementById("Amount_collection").value) || 0;
        var Discount = parseFloat(document.getElementById("Discount").value) || 0;
        var Rate_VAT = parseFloat(document.getElementById("Rate_VAT").value) || 0;

        // Calculate the amount after discount
        var Amount_after_discount = Amount_collection - Discount;
        ...
        if (!Amount_after_discount) {
            ...
            var Total_amount = Amount_after_discount + VAT_value;

            // Round and set values
