        ...
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <form action="/Search_invoices" method="POST" role="search" autocomplete="off">
                    @csrf <!-- Modern way of adding CSRF token -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                            ...
                            <input type="text" class="form-control" id="invoice_number_input" name="invoice_number">
                        </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('InvoicesDetails/' . $invoice->id) }}">
                                                {{ $invoice->section->section_name ?? 'N/A' }}
                                            </a>
                                        </td>
                                        ...
                                        <td>{{ $invoice->Total }}</td>
                                        <td>
                                            <span class="{{ $invoice->Value_Status == 1 ? 'text-success' : ($invoice->Value_Status == 2 ? 'text-danger' : 'text-warning') }}">
                                                {{ $invoice->Status }}
                                            </span>
                                        </td>
                                        <td>{{ $invoice->note }}</td>
                    ...
                    @else
                        <p class="text-center">لا توجد بيانات مطابقة لنتائج البحث.</p>
                    @endif
                </div>
            </div>
        </div>
